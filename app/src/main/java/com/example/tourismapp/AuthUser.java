...
public class AuthUser {
   public static String username, firstName, lastName, password,gender,userId;
    ...
    public AuthUser(String firstName,String lastName,String gender,String username,String password, String userId) {
